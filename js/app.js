...
App.RatesView = new (BikeJS.View.extend({
  ...
  getControll: function() {
    ...
    return {
      button: function() {
        return {
          block: function() {self.$button.addClass('disabled');return this;},
          unblock: function() {self.$button.removeClass('disabled');return this;}
        }
      },

      select: function() {
        return {
          block: function() {self.$select.attr('disabled', 'disabled');return this;},
          unblock: function() {self.$select.removeAttr('disabled', 'disabled');return this;},
          text: function(text) {self.$selectHolder.html(text);return this;}
        }
      },

      loader: function() {
        return {
          show: function() {self.$loader.removeClass('hide');return this;},
          hide: function() {self.$loader.addClass('hide');return this;}
        }
      },

      table: function() {
        return {
          show: function() {self.$table.removeClass('hide');return this;},
          hide: function() {self.$table.addClass('hide');return this;}
        }
      },

      message: function() {
        return {
          'show': function(text){self.$message.removeClass('hide');return this;},
          'hide': function(text){self.$message.addClass('hide');return this;},
          'text': function(text){self.$message.html(text);return this;},
          'type': function(type){self.$message.addClass('msg-' + type);return this;}  
        }
      },
